...
class Buy_Items extends CI_Controller {
    ...
    public function index($slug='publish'){
        ...
        add_footer_js(array('main-admin.js','admin-buy-items.js'));
        ...
        if ($this->form_validation->run() == FALSE){
            ...
            foreach ($items as $key => $item) {
                ...
                if(!empty($dt)){
                    ...
                    if(!$this->buy_item_model->save_detail($id_buy_items_detail, $id_buy_items, $id_item, $mid, $item, $category,
            ...
            if($error==0){//save buy_item
                if(!$this->buy_item_model->save($id_buy_items, $date, $total)) $error++;
            }
