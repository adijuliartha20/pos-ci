				    				...
				    				<tr id="tr-<?php echo $dt['id_store']; ?>">
				    					...
				    					<td>
				    						...
				    						<p class="small-action">
				    							<?php 
				    								if($state=='trash'){?>
				    									<a onclick="action_row(event,<?php echo $dt['id_store']; ?>,'publish')">Restore</a> | <a onclick="action_row(event,<?php echo $dt['id_store']; ?>,'delete')">Delete Permanently</a>
				    								<?php
				    								}else{?>
				    									<a href="<?php echo ADMIN_URL.'/'.$app.'/edit/'.$dt['id_store']; ?>">Edit</a> | <a onclick="action_row(event,<?php echo $dt['id_store']; ?> , 'trash')">Move Trash</a>
				    								<?php
				    								}
				    							?>
