<div class="content-i">
    <div class="content-box">
      	<div class="element-wrapper">
	        <h6 class="element-header"><?php echo $title; ?> Item Record</span></h6>
			<div class="element-box">

				<form id="form-report" class="form-inline form-desc" action="<?php echo ADMIN_URL.'/report/get-item-record'; ?>">
