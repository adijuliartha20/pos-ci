<div class="content-i">
    <div class="content-box">
      	<div class="element-wrapper">
	        <h6 class="element-header"><?php echo $title; ?> Buy Items</span></h6>
			<div class="element-box">

				<form id="form-report" class="form-inline form-desc" action="<?php echo ADMIN_URL.'/report/get-buy-items-report'; ?>">
			      	<span class="lbl-form-inline">Start</span>
			      	...
			      	<span class="lbl-form-inline">End</span>
