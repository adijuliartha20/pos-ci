<div class="content-i">
    <div class="content-box">
      	<div class="element-wrapper">
	        <h6 class="element-header"><?php echo $title; ?> : <span id="num-transaction"><?php echo $num_transaction; ?></span></h6>
			<div class="element-box">
				...
				<form id="form-add-item" class="form-inline">
			      	<input id="id" class="form-control mb-2 mr-sm-2 mb-sm-0" placeholder="ID" type="text" onkeyup="get_item_data(0)" onkeypress="keyPressEvent(event)">
			      	...
			      	<input id="discount" class="form-control mb-2 mr-sm-2 mb-sm-0 currency" placeholder="Discount" type="text"
			      	<?php echo ($dpi=='enable'? '':'disabled="disabled"'); ?> onkeypress="focus_qty(event)">


			      	<input id="qty" class="form-control mb-2 mr-sm-2 mb-sm-0" placeholder="Qty" type="number" min="1" onkeypress="keyPressEvent(event)">
					...
					<table id="table-transaction" class="table table-editable table-striped table-lightfont">
						...
						<tfoot>
			    			<tr>
								...
								<th id="total-text">---</th>
								<th><input type="button" name="get-form-pay" value="Pay Now" class="mr-2 mb-2 btn btn-danger" data-target="#onboardingFormModal" data-toggle="modal" onclick="set_value_form_payment(event)"></th>
							</tr>
			    		</tfoot>
						<tbody>
						</tbody>
	    ...
	    <div class="onboarding-content with-gradient">
	      ...
	      <form id="form-payment" class="form-payment">
	      	<div class="col-sm-12">
				  ...
				  <label for="">Manual Discount</label>
				...
				<div class="form-group">
				  ...
				  <input class="form-control currency" placeholder="Enter your payment" type="text" value="" id="payment" onkeyup="calculate_change(event)" onkeypress="focus_st(event)">
				</div>
				<div class="form-group">
				...
				<br>
				<div class="form-group">
				  <input type="button" id="save-transaction" value="Save Transaction" class="mr-2 mb-2 btn btn-danger" onclick="save_transaction(event)">
				</div>
			</div>
	      </form>
