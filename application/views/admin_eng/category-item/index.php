				    				...
				    				<tr id="tr-<?php echo $dt['id_cat']; ?>">
				    					...
				    					<td>
				    						...
				    						<p class="small-action">
				    							<?php 
				    								if($state=='trash'){?>
				    									<a onclick="action_row(event,<?php echo $dt['id_cat']; ?>,'publish')">Restore</a> | <a onclick="action_row(event,<?php echo $dt['id_cat']; ?>,'delete')">Delete Permanently</a>
				    								<?php
				    								}else{?>
				    									<a href="<?php echo ADMIN_URL.'/'.$app.'/edit/'.$dt['id_cat']; ?>">Edit</a> | <a onclick="action_row(event,<?php echo $dt['id_cat']; ?> , 'trash')">Move Trash</a>
				    								<?php
				    								}
				    							?>
