        ...
        <div class="os-tabs-w">
          <div class="os-tabs-controls">
            <ul class="nav nav-tabs smaller">
              ...
              <li class="nav-item">
                <a class="nav-link active" data-toggle="tab" href="#tab_month">Month</a>
              </li>
              <li class="nav-item">
                <a class="nav-link" data-toggle="tab" href="#tab_year">Year</a>
              </li>
            </ul>
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane active" id="tab_month">
              ...
              <button class="mr-2 mb-2 btn btn-outline-primary btn-add" type="submit">View</button>
              </form>
