				    				...
				    				<tr id="tr-<?php echo $dt['id_event']; ?>">
				    					...
				    					<td>
				    						...
				    						<p class="small-action">
				    							<?php 
				    								if($state=='trash'){?>
				    									<a onclick="action_row(event,<?php echo $dt['id_event']; ?>,'publish')">Restore</a> | <a onclick="action_row(event,<?php echo $dt['id_event']; ?>,'delete')">Delete Permanently</a>
				    								<?php
				    								}else{?>
				    									<a href="<?php echo ADMIN_URL.'/'.$app.'/edit/'.$dt['id_event']; ?>">Edit</a> | <a onclick="action_row(event,<?php echo $dt['id_event']; ?> , 'trash')">Move Trash</a>
				    								<?php
				    								}
				    							?>
