				    				...
				    				<tr id="tr-<?php echo $dt['id_user']; ?>">
				    					...
				    					<td>
				    						...
				    						<p class="small-action">
				    							<?php 
				    								if($state=='trash'){?>
				    									<a onclick="action_row(event,<?php echo $dt['id_user']; ?>,'publish')">Restore</a> | <a onclick="action_row(event,<?php echo $dt['id_user']; ?>,'delete')">Delete Permanen</a>
				    								<?php
				    								}else{?>
				    									<a href="<?php echo ADMIN_URL.'/'.$app.'/edit/'.$dt['id_user']; ?>">Edit</a> | <a onclick="action_row(event,<?php echo $dt['id_user']; ?> , 'trash')">Pindah ke sampah</a>
				    								<?php
				    								}
				    							?>
