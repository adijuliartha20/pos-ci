<div class="content-i">
    <div class="content-box">
      	<div class="element-wrapper">
	        <h6 class="element-header">Konsumen <input type="button" name="" value="Tambah" class="btn btn-primary"  onclick="location.href = '<?php echo ADMIN_URL.'/'.$app.'/create'; ?>';"></h6>
				    		...
				    		<tbody>
				    			<?php 
				    				foreach ($data as $key => $dt) {
				    					?>
				    				<tr id="tr-<?php echo $dt['id_customer']; ?>">
				    					<td>
				    						<input type="checkbox" name="ids[]" value="<?php echo $dt['id_customer']; ?>" >
				    					</td>
				    					...
				    					<td>
				    						...
				    						<p class="small-action">
				    							<?php 
				    								if($state=='trash'){?>
				    									<a onclick="action_row(event,<?php echo $dt['id_customer']; ?>,'publish')">Restore</a> <!--| <a onclick="action_row(event,<?php echo $dt['id_country']; ?>,'delete')">Delete Permanently</a>-->
				    								<?php
				    								}else{?>
				    									<a href="<?php echo ADMIN_URL.'/'.$app.'/edit/'.$dt['id_customer']; ?>">Edit</a> | <a onclick="action_row(event,<?php echo $dt['id_customer']; ?> , 'trash')">Move Trash</a>
				    								<?php
				    								}
				    							?>
				    					...
				    					<td><?php echo ($dt['gender']==1? 'Pria' : 'Perempuan'); ?></td>
				    					<td><?php echo $dt['name_sub_district']; ?></td>
