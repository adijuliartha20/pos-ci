...
<html>
  ...
  <body class="auth-wrapper">
      ...
      <div class="auth-box-w">
        ...
        <form id="formValidate" action="<?php echo ADMIN_URL.'/login'; ?>">        
          <div class="form-group">
            <label for="">Username</label><input class="form-control" data-error="Username wajib diisi" placeholder="Masukkan username anda" required="required"  type="text" id="username" name="username">
            <div class="pre-icon os-icon os-icon-user-male-circle"></div>
          </div>
          <div class="form-group">
            <label for="">Password</label><input class="form-control" data-error="Password wajib diisi" placeholder="Masukkan password anda" required="required" type="password" id="password" name="password">
            <div class="pre-icon os-icon os-icon-fingerprint"></div>
          </div>
          <div class="buttons-w">
            <button class="btn btn-primary"  >Login</button>
            <div class="form-check-inline">
              <label class="form-check-label"><input class="form-check-input" type="checkbox" id="remember" name="remember">Ingat saya</label>
            </div>
          </div>
    ...
    <input type="hidden" id="ajax_login" value="">
  </body>
</html>